...
class Config(object):
    ...
    DEF_THUMB_NAIL_VID_S = os.environ.get("DEF_THUMB_NAIL_VID_S", "https://telegra.ph/file/8177dc6b998693d4e0208.gif")
    ...
    STATUS_COMMAND = os.environ.get("STATUS_COMMAND", "statusL")
    ...
    RENEWME_COMMAND = os.environ.get("RENEWME_COMMAND", "clearme1")
